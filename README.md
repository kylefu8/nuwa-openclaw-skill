...
- **知名人物**（一手来源 ≥10）：标准 Skill（~4,500 tokens）— 实测芒格 4,701 / 巴菲特 4,565 / 达里奥 4,717
...
- **Well-known figures** (10+ primary sources): Standard Skill (~4,500 tokens) — measured: Munger 4,701 / Buffett 4,565 / Dalio 4,717
